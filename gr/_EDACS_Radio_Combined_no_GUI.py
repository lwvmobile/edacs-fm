...
# Title: EDACS Radio Combined no GUI
# Author: lwvmobile
...
class EDACS_Radio_Combined_no_GUI(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "EDACS Radio Combined no GUI", catch_exceptions=True)
        ...
        self.rtlsdr_source_0_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'rtl=00000003'
        )
        ...
        self.rtlsdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'rtl=00000004'
        )
...
def main(top_block_cls=EDACS_Radio_Combined_no_GUI, options=None):
    tb = top_block_cls()
