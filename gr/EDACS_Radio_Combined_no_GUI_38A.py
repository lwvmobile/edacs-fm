...
# Title: EDACS Radio Combined no GUI 38 Airspy
# Author: lwvmobile
...
class EDACS_Radio_Combined_no_GUI_38A(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "EDACS Radio Combined no GUI 38 Airspy")
        ...
        self.connect((self.osmosdr_source_0, 1), (self.rational_resampler_xxx_0_0, 0))
...
def main(top_block_cls=EDACS_Radio_Combined_no_GUI_38A, options=None):
    tb = top_block_cls()
