...
class EDACS_Radio_Combined_no_GUI_37(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "EDACS Radio Combined no GUI 37")
...
def main(top_block_cls=EDACS_Radio_Combined_no_GUI_37, options=None):
